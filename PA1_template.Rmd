...
A: This requires the data to be aggregated by the interval. Note that the xlabels 
refer to 5 minute interval time slots, ranging from 00:00 hours to 24:00 hours.
...
plot(y = steps_per_interval$steps_pi, x = steps_per_interval$interval, 
        type = "l", xlab = "5 minute intervals", main = "Pattern of Daily 
        Activity", ylab = "Average steps")
